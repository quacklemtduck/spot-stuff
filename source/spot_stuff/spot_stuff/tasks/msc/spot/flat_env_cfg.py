...
class BenchmarkCommandsCfg:
    ...
    goal_command = spot_mdp.WorldPoseCommandCfg(
        ...
        positions=[
            ...
            (0.5, 0.3, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.5, -0.3, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.5, 0.0, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.5, 0.3, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.5, -0.3, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.5, 0.0, 0.7, 0.819, 0.0, 0.574, 0.0),
            (0.5, 0.3, 0.7, 0.819, 0.0, 0.574, 0.0),
            (0.5, -0.3, 0.7, 0.819, 0.0, 0.574, 0.0)],

            #Extremes - Far away
            [(0.8, 0.0, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.8, 0.4, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.8, -0.4, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.8, 0.0, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.8, 0.4, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.8, -0.4, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.8, 0.0, 0.7, 0.819, 0.0, 0.574, 0.0),
            (0.8, 0.4, 0.7, 0.819, 0.0, 0.574, 0.0),
            (0.8, -0.4, 0.7, 0.819, 0.0, 0.574, 0.0)],

            #Extremes - Close
            [(0.3, 0.0, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.3, 0.2, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.3, -0.2, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.3, 0.0, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.3, 0.2, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.3, -0.2, 0.2, 0.819, 0.0, 0.574, 0.0),
            (0.3, 0.0, 0.7, 0.819, 0.0, 0.574, 0.0),
            (0.3, 0.2, 0.7, 0.819, 0.0, 0.574, 0.0),
            (0.3, -0.2, 0.7, 0.819, 0.0, 0.574, 0.0)],

            #Right side
            [(0.0, -0.4, 0.5, 0.819, 0.0, 0.574, 0.0),
            (0.0, -0.5, 0.5, 0.819, 0.0, 0.574, 0.0),
            (-0.1, -0.4, 0.5, 0.819, 0.0, 0.574, 0.0)],
